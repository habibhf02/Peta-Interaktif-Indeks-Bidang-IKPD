...
provinces.forEach(p => {
  p.addEventListener("click", () => {
    ...
    if (indikator === "ALL" && tahun === "ALL") {
      ...
      popupBox.style.maxWidth = "1300px";
      popupBox.style.height = "88vh";
    ...
    for (let th in dataIDIpusat) {
      ...
      ">
        ...
        <div style="
          ...
          margin-bottom:4px;
        ">
          <strong style="text-decoration:underline;">Pusat</strong><br>
          ${dataIDIpusat[th] ?? "-"}
        </div>
        ...
        <div style="
          font-size:12px;
        ">
          <strong style="text-decoration:underline;">Prov</strong><br>
          ${dataIDIprovinsi[th] ?? "-"}
        </div>
      </div>
      `;
